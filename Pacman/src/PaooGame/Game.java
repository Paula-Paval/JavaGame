...
public class Game implements Runnable
{
    ...
    private State winState;        /*!< Referinta catre win.*/
    private State gameover;           /*!< Referinta catre game over.*/

    private State history;           /*!< Referinta catre history.*/
    ...
    public Game(String title, int width, int height)
    {
        ...
        //Construirea obiectului de gestionarea a evenimentelor de la mouse
    ...
    private void InitGame() throws IOException {
        ...
        //se ataseaza ferestrei managerul pentru a primi evenimente furnizate de mouse
    ...
    /*! \fn publicc void SetPlayState()
          \brief Seteaza starea de play.
       */
    ...
    public void SetWinState(){State.SetState(winState);}
    /*! \fn publicc void SetPlayState()
         \brief Seteaza starea de history.
      */
    public void SetHistoryState(){State.SetState(history);}
     /*! \fn publicc void SetPlayState()
          \brief Seteaza starea de game over sate.
       */

    public void SetGameOverState(){State.SetState(gameover);}
    /*! \fn publicc void SetPlayState()
         \brief Seteaza starea de menu.
      */
    public void SetMenuState(){State.SetState(menuState);}
    /*! \fn public Mouse GetMouseManager()
       \brief Returneaza obiectul care gestioneaza mouse.
    */
    public MouseManager GetMouseManager()
    {
     ...
     /*! \fn public int  getLevel()
       \brief Returneaza levelul
    */

    public int  getLevel()
    {
        if(State.GetState() != null) {
            return State.GetState().getLevel();
        }
        else
        {
            return 0;
    ...
    /*! \fn publicGameWindow getWnd()
      \brief Returneaza referinta la fereastra
   */
    public GameWindow getWnd() {
        return wnd;
    }
     /*! \fn boolean isRunState()
      \brief Returneaza daca jocul ruleaza sau nu
   */
